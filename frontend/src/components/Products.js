    ...
    let item = `item-${idx}`,
      ...
      <div className="addNewItem" key={idx}>
        ...
        <div className="prices">
          ...
          <label htmlFor="subtotal" className="totalLabel">Subtotal :</label>
          <input  id={subtotal} data-id={idx} className="totalInp" name="subtotal" defaultValue={val?val.subtotal:''}   readOnly />
          </div>
          <div className="totalElem">
          <label htmlFor="subtotal" className="totalLabel">Discount :</label>
          <input className="totalInp"  defaultValue={val.discount}  readOnly />
          </div>
          <div className="totalElem">
          <label htmlFor="subtotal" className="totalLabel">Total :</label>
          <input id={total} data-id={idx} className="totalInp" name="total" defaultValue={val?val.total:''} readOnly/>
          </div>
          <div className="delete-btn" onClick={() => props.delete(val)}>
            <div className="icon">
